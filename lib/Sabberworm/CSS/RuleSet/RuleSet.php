...
abstract class RuleSet {
    ...
    /**
     * 
     * @param \Sabberworm\CSS\Rule\Rule $oRule
     */
    ...
    * @param (null|string|\Sabberworm\CSS\Rule\Rule) $mRule pattern to remove. If $mRule is null, all rules are removed. If the pattern ends in a dash, all rules starting with the pattern are removed as well as one matching the pattern with the dash excluded. Passing a Rule behaves matches by identity.
    * @return type
     */
